...
QT += core gui network widgets network printsupport
...
win32 {
	...
	PNG_LIB_PATH=C:/deps64b/libpng-1.6.16/.libs
}

build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.Doubloon
    BOOST_LIB_SUFFIX=-mt
...
!win32 {
	...
	# MAKE_CLEAN += $$PWD/src/leveldb/libleveldb.a; cd $$PWD/src/leveldb ; $(MAKE) clean
} else {
...
macx:ICON = src/qt/res/icons/Doubloon.icns
macx:TARGET = "Doubloon-Qt"
...
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,) $$join(PNG_LIB_PATH,,-L,)
