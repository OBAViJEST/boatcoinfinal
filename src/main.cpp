...
unsigned int nTargetSpacing     = 90;					// minute + half
...
const string strMessageMagic = "Doubloon Signed Message:\n";
...
int CMerkleTx::SetMerkleBranch(const CBlock* pblock)
{
    ...
    if (nIndex == (int)pblock->vtx.size())
    {
        vMerkleBranch.clear();
        nIndex = -1;
        printf("Yarrr! SetMerkleBranch() : couldn't find tx in block\n");
        return 0;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Doubloon", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Pascal pumped on Poloniex";
        CTransaction txNew;
        txNew.nTime = 1485546179;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1485546179;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2959126 : 2959126;
 ...
 //        hashGenesisBlock = block.GetHash();
        ...
        block.print();
//        assert(block.hashMerkleRoot == uint256("0xeb42ae0324ea968b5cdcd959104fc3b1cd93c45e25ba5be25b5e55deaf21254c"));
        assert(block.hashMerkleRoot == uint256("0x4bdd51629df6c8281d13c9160a98697f777f9d7b3af69de145a3118b13c31c24"));
    ...
    string strPubKey = "0424727954ea02c6ee7e03dc790622184349bb52a90cd0a1ef52908e98e64501df7afb3e8fdd8569a2b44e44f1574a6ca3882a9c67554f6bc6f4fbe5e9e2e2dbf0";
...
unsigned char pchMessageStart[4] = { 0x1c, 0x3b, 0x1a, 0xa3 };
