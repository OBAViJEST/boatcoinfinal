    ...
    model(0)
{
    ...
    ui->addAsLabel->setPlaceholderText(tr("Enter a label for this scallywag to add it to your Captain's Log"));
    ui->payTo->setPlaceholderText(tr("Enter an Doubloon address (e.g. B96m4dNBqCLh7ZYceQnLG7uPuva5mochZK)"));
