...
// Copyright (c) 2014-2015 The Doubloon developers
// Copyright (c) 2015 The Doubloon developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("Doubloon-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("Doubloon-smsg-pow"); // Make this thread recognisable
